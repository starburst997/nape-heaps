...
class GraphicsDebug extends Debug{
    /**
     * @private
     */
    public var zpp_inner_zn:ZPP_GraphicsDebug=null;
    /**
    ...
    #end
    public function new(g:h2d.Graphics,width:Int,height:Int,bgColour=0x333333){
        ...
        #end
        zpp_inner_zn=new ZPP_GraphicsDebug(g,width,height);
